  ...
  <div class="app-container">
    <el-container style="height: 100%; border: 1px solid #eee">
      ...
      >
        <el-container>
          ...
          <el-main>
             <el-input placeholder="Bay Filter" v-model="filterText" clearable  style="margin-top:10px;" size="mini"></el-input>
          ...
          <el-main>
            ...
            >
              ...
              <el-table-column label="Bay" min-width="140px" align="center">
               ...
               <el-table-column label="Position" min-width="140px" align="center">
                <template slot-scope="scope">
                  <span>{{ scope.row.Position }}</span>
                </template>
              </el-table-column>
                <!-- <el-table-column label="Machines" v-show = "false" min-width="140px" align="center">
                <template slot-scope="scope">
              ...
              <el-table-column label="Mac Addr." min-width="140px" align="center">
                <template slot-scope="scope">
    ...
    <div style="height:600px">
      ...
      >
        ...
        <el-form-item class="postInfo-container-item" label="Bay" prop="LineId">
          <el-select
            v-model="temp.LineId"
            placeholder="Line"
            clearable
        ...
        <el-form-item label="Position" prop="Position">
         ...
         <el-form-item label="VA" prop="VA">
            <el-input placeholder="please input the va address" v-model="temp.Va" style="width: 300px">
              <template slot="prepend">Http://</template>
            </el-input>
        </el-form-item>
         <el-form-item label="WI" prop="WI">
            <el-input placeholder="please input the WI address" v-model="temp.Wi" style="width: 300px">
              <template slot="prepend">Http://</template>
            </el-input>
        </el-form-item>
        ...
        <el-form-item label="Mac Address" prop="ip">
          <the-mask mask="XX-XX-XX-XX-XX-XX" v-model="temp.Mac"  type="text" masked="false" placeholder="MAC address"></the-mask>
        </el-form-item>
