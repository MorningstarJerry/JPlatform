              ...
              <sticky :z-index="10" :class-name="'stickyFoot'">
                ...
                <el-button-group>
                  <el-button
                    ...
                    :disabled="!canOperater"
                    @click="handleSummary"
                    >Generate Space Summary</el-button
                  >
                  <el-button
                    type="success"
                    icon="el-icon-search"
                    ...
                    @click="handleSGraph"
                    :disabled="!canOperater"
                    >Generate Space Graph</el-button
                  >
                   <el-button
                    type="danger"
                    icon="el-icon-search"
                    ...
                    @click="handleRGraph"
                    :disabled="!canOperater"
                    >Generate Revenu Graph</el-button
                  >
                </el-button-group>
              </sticky>
            </div>
...
import { getForecastLists } from "@/api/space";
...
export default {
  ...
  methods: {
    ...
    handleSummary() {
      this.$router.push({ path: "/Functions/Space/Summary" });
    },
    handleSGraph() {
      this.$router.push({ path: "/Functions/Space/Graph" ,query: { type: 'space' }});
    },
     handleRGraph() {
      this.$router.push({ path: "/Functions/Space/Graph" ,query: { type: 'revenu' }});
    },
    handlerSearch() {
      debugger;
      var obj = this.value7;
    ...
    getListsByQuery(query) {
      ...
      debugger;
      getForecastLists(query).then(response => {
        debugger;
