<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Workcell" width="120px">
        <template slot-scope="{row}">
          <span>{{ GetWCName(row.WorkcellId) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Equipment Type" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ GetEquipmentTypeName(scope.row.EquipmentTypeId) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Code" min-width="140px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.Code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Name" min-width="140px" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item class="postInfo-container-item" label="Work cell" prop="WorkcellId">
          <el-select
        ...
        <el-form-item class="postInfo-container-item" label="Equipment Type" prop="EquipmentTypeId">
          <el-select
            v-model="temp.EquipmentTypeId"
            clearable
            class="filter-item"
            placeholder="Please select"
          >
