        ...
        <el-container>
          <el-main>
            <div style="height:400px;">
              ...
              >
                <el-table-column prop="Code" label="Code" width="80" fixed="">
                </el-table-column>
                <el-table-column prop="Name" label="Name" width="120">
                </el-table-column>
                 <el-table-column prop="Size" label="Size(sq.ft)" width="120">
                </el-table-column>
                <el-table-column
                  prop="Gid"
                  label="Gid"
          ...
          <el-main>
            <div>
              ...
              >
                ...
                <el-table-column label="Size(sq.ft)" width="120px" align="left">
                  <template slot-scope="scope">
                    <el-input size="mini"  :disabled="!canOperater" v-model="scope.row.Size" placeholder=""></el-input>
                  </template>
                </el-table-column>
              </el-table>
              <div
                style="text-align : right; margin-right:20px; margin-top:15px;"
              >
                <el-button
                  class="filter-item"
...
import { Create, Update, Delete, SearchByCode } from "@/api/station";

import { getLineTrees, getLineOptionsByQuery } from "@/api/lines";

import { getListsByQuery, getSpace, mapSpace } from "@/api/space";
